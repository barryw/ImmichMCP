...
public class AssetToolsTests
{
    ...
    [Fact]
    public async Task Delete_ReturnsValidationError_WhenAssetIdsEmpty()
    {
        // Arrange
        var (client, _) = MockHttpClientFactory.CreateMockClient();

        // Act
        var response = await AssetTools.Delete(client, " ");
    ...
    [Fact]
    public async Task Delete_DoesNotCallUpstreamDelete_WhenDryRunDefaultAndNotConfirmed()
    {
        // Arrange: default dryRun=true, confirm=false, the safety-critical default path.
        var (client, handler) = MockHttpClientFactory.CreateMockClient();
        var asset = TestFixtures.CreateAsset(id: "asset-1", originalFileName: "photo.jpg");
        ...
        // Act
        var response = await AssetTools.Delete(client, "asset-1");
    ...
    [Fact]
    public async Task Delete_DoesNotCallUpstreamDelete_WhenDryRunFalseButNotConfirmed()
    {
        ...
        // Act
        var response = await AssetTools.Delete(client, "asset-1", dryRun: false, confirm: false);
    ...
    [Fact]
    public async Task Delete_DoesNotCallUpstreamDelete_WhenConfirmedButDryRunTrue()
    {
        // Arrange: dryRun defaults to true, so passing confirm=true alone must not be enough to delete.
        var (client, handler) = MockHttpClientFactory.CreateMockClient();
        var asset = TestFixtures.CreateAsset(id: "asset-1", originalFileName: "photo.jpg");
        ...
        // Act
        var response = await AssetTools.Delete(client, "asset-1", confirm: true);
    ...
    [Fact]
    public async Task Delete_CallsUpstreamDelete_WhenDryRunFalseAndConfirmed()
    {
        // Arrange
        var (client, handler) = MockHttpClientFactory.CreateMockClient();
        string? capturedRequestBody = null;
        ...
        // Act
        var response = await AssetTools.Delete(client, "asset-1,asset-2", dryRun: false, confirm: true);
    ...
    [Fact]
    public async Task Delete_PassesForceFlag_WhenSet()
    {
        // Arrange
        var (client, handler) = MockHttpClientFactory.CreateMockClient();
        string? capturedRequestBody = null;
        ...
        // Act
        var response = await AssetTools.Delete(client, "asset-1", force: true, dryRun: false, confirm: true);
